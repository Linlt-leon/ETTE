...
import torch
import transformers
from transformers import (AutoConfig, AutoModel, AutoTokenizer, BertTokenizer,BertForTokenClassification, BartForConditionalGeneration,
...
parser.add_argument("--dataset", default="gec",type=str)
...
length_map={'lcsts':'30','csl':'50','adgen':'128','gec':'128'}


args=[
    '--model_name_or_path',arg_dict['model_path'],
    '--do_train','--do_eval','--do_predict',
    '--train_file',os.path.join(arg_dict['data_dir'],'ABC.train.gold.bea19.json'),
    '--validation_file',os.path.join(arg_dict['data_dir'],'ABCN.dev.gold.bea19.json'),
    '--test_file',os.path.join(arg_dict['data_dir'],'ABCN.dev.gold.bea19.json'),
    '--output_dir',outdir,
    ...
    # '--warmup-updates', str(5000),
    # '--dropout', str(0.3),
    # '--attention-dropout', str(0.1),
    # '--optimizer', 'adam',
    # '--adam-eps', str(1e-06),
    # '--adam-betas', str('(0.9, 0.98)')
